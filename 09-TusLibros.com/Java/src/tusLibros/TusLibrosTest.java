...
public class TusLibrosTest {
	...
	private MerchantProcessor obtenerMerch(){
		...
		listTarjRobadas.add(new TarjetaDeCredito("1234567890123459", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE"));
		
		TarjetaDeCredito tarj1 = new TarjetaDeCredito("1234567890123456",  String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JULIAN");
		TarjetaDeCredito tarj2 = new TarjetaDeCredito("1234567890123148",  String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ PEDRO");
		TarjetaDeCredito tarj3 = new TarjetaDeCredito("1234567890123149",  String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JUAN");
		TarjetaDeCredito tarj4 = new TarjetaDeCredito("1234567890123150",  String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ PABLO");
		
		TarjetaDeCredito tarj5 = new TarjetaDeCredito("1234567890123450", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE");
	...
	public void test16AlHacerCheckOutDeUnCarritoConUnElementoMeCobraElPrecioDeEseElementoYSeEncuentraLibroVenta(){
		...
		carrito.agregar(elem, 1);
		Calendar hoy = new GregorianCalendar();
		TarjetaDeCredito tarjeta = new TarjetaDeCredito("1234567890123456",  String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JULIAN");
	...
	public void test40MedianteLaInterfaceLuegoDeCheckOutLasComprasDeUnClienteContienenLosElementosDelCarrito() {	
		...
		Calendar hoy = new GregorianCalendar();
		interfa.checkOutCarrito(idCarrito, "1234567890123450", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE");
		Multiconjunto<Object, Integer> comprasCliente = interfa.listarComprasCliente(0, "password");
	...
	public void test41MedianteLaInterfaceLosNumerosDeTransaccionPorCheckOutsSonTodosDistintos() {	
		...
		Calendar hoy = new GregorianCalendar();
		long transId1= interfa.checkOutCarrito(idCarrito, "1234567890123450", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE");
		long transId2= interfa.checkOutCarrito(idCarrito2, "1234567890123450", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE");
		long transId3= interfa.checkOutCarrito(idCarrito3, "1234567890123450", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE");
	...
	public void test43MedianteLaInterfaceNoSePuedeHacerCheckOutTarjetaRobada() {	
		try {
			...
			interfa.agregarACarrito(idCarrito, prod2, 8);
			Calendar hoy = new GregorianCalendar();
			interfa.checkOutCarrito(idCarrito, "1234567890123459", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE");
			fail();
		} catch (Error e){
	...
	public void test44MedianteLaInterfaceNoSePuedeHacerCheckOutTarjetaInexistente() {	
		try {
			...
			interfa.agregarACarrito(idCarrito, prod2, 8);
			Calendar hoy = new GregorianCalendar();
			interfa.checkOutCarrito(idCarrito, "1234567890123754", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JOSE");
			fail();
		} catch (Error e){
	...
	public void test45MedianteLaInterfaceNoSePuedeHacerCheckOutCuentaSinFondos() {	
		try {
			...
			interfa.agregarACarrito(idCarrito, prod2, 8);
			Calendar hoy = new GregorianCalendar();
			interfa.checkOutCarrito(idCarrito, "1234567890123148", String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ PEDRO");
			fail();
		} catch (Error e){
	...
	public void test46MedianteLaInterfaceNoSePuedeHacerCheckOutCuentaSaldoMenor() {	
		try {
			...
			interfa.agregarACarrito(idCarrito, prod2, 8);
			Calendar hoy = new GregorianCalendar();
			interfa.checkOutCarrito(idCarrito, "1234567890123149",  String.format("%2d%4d", hoy.get(Calendar.MONTH) +1, hoy.get(Calendar.YEAR) +1), "LOPEZ JUAN");
			fail();
		} catch (Error e){
	...
	@Test
	public void test46SiUnCarritoNoEsUsadoPorMasDe30MinutosDejaDeSerValido() {	
		try {
			Map<Object, Double> catalogo = new HashMap<Object, Double>();
			int elem1 = 1;
			int elem2 = 2;
